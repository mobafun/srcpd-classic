...
extern int readConfig_LOCONET(xmlDocPtr doc, xmlNodePtr node, bus_t busnumber);
extern int init_bus_LOCONET(bus_t);
extern int getDescription_LOCONET(char *reply);
extern void *thr_sendrec_LOCONET(void *);
...
#define CONSIST_NO (0)
#define CONSIST_STAT(s) (((s & CONSIST_MASK) == CONSIST_MID) ? "Mid-Consisted" : (((s & CONSIST_MASK) == CONSIST_TOP) ? "Consist TOP" : (((s & CONSIST_MASK) == CONSIST_SUB) ? "Sub-Consisted" : "Not Consisted")))
...
#define LOCO_FREE (0)
#define LOCO_STAT(s) (((s & LOCOSTAT_MASK) == LOCO_IN_USE) ? "In-Use" : (((s & LOCOSTAT_MASK) == LOCO_IDLE) ? "Idle" : (((s & LOCOSTAT_MASK) == LOCO_COMMON) ? "Common" : "Free")))
...
#define DEC_MODE(s) (((s & DEC_MODE_MASK) == DEC_MODE_128A) ? "128 (Allow Adv. consisting)" : (((s & DEC_MODE_MASK) == DEC_MODE_28A) ? "28 (Allow Adv. consisting)" : (((s & DEC_MODE_MASK) == DEC_MODE_128) ? "128" : (((s & DEC_MODE_MASK) == DEC_MODE_14) ? "14" : (((s & DEC_MODE_MASK) == DEC_MODE_28TRI) ? "28 (Motorola)" : "28")))))
