...
extern void run_bus_watchdog();
extern void create_all_bus_threads();
extern void cancel_all_bus_threads();
extern void suspend_bus_thread(bus_t bus);
extern void resume_bus_thread(bus_t bus);
extern int bus_supports_protocol(bus_t bus, const char protocol);
...
extern int bus_has_devicegroup(bus_t bus, int dg);
