...
extern int readConfig_IB(xmlDocPtr doc, xmlNodePtr node, bus_t busnumber);
extern int init_bus_IB(bus_t busnumber);
extern int init_gl_IB(gl_state_t *gl);
extern int init_ga_IB(ga_state_t *ga);
extern void *thr_sendrec_IB(void *);
