...
extern int readconfig_Selectrix(xmlDocPtr doc, xmlNodePtr node, bus_t busnumber);

/* Methods for Selectrix */
extern int init_lineSelectrix(bus_t bus);
extern int init_bus_Selectrix(bus_t bus);
extern int init_gl_Selectrix(gl_state_t *gl);
extern int init_ga_Selectrix(ga_state_t *ga);
extern int init_fb_Selectrix(bus_t busnumber, int addr, const char protocol, int index);
extern void *thr_commandSelectrix(void *);
extern void *thr_feedbackSelectrix(void *);
extern void sig_processSelectrix(bus_t busnumber);
