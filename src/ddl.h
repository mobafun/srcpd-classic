...
extern int readconfig_DDL(xmlDocPtr doc, xmlNodePtr node, bus_t busnumber);
extern int init_bus_DDL(bus_t busnumber);
...
extern void queue_add(bus_t busnumber, int addr, char *const packet,
                      int packet_type, int packet_size);

extern char *get_maerklin_packet(bus_t busnumber, int adr, int fx);
extern void update_MaerklinPacketPool(bus_t busnumber, int adr,
                                      char const *const sd_packet,
                                      char const *const f1, char const *const f2,
                                      char const *const f3, char const *const f4);
extern void update_NMRAPacketPool(bus_t busnumber, int adr,
