...
extern int readconfig_I2C_DEV(xmlDocPtr doc, xmlNodePtr node, bus_t busnumber);
extern int init_lineI2C_DEV(bus_t);
extern int init_bus_I2C_DEV(bus_t);
extern int getDescription_I2C_DEV(char *reply);
extern void *thr_sendrec_I2C_DEV(void *);
